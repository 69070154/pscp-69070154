...
| OJ submission ID, if submitted | 544268 |
| OJ status | Pass |
...
```text
ฉัน ถามว่า code ฉันผิดตรงไหน ทำไหม testcases 3 อันนี้ถึงไม่ผ่านสักที
```
...
```text
ai ช่วยบอกใบ้ว่า ถ้าเป็นสีเดียวกันผสมกันจะได้สีไร
```
...
```text
ทำให้ผมกลับเขียน เงื่อนไข elif เพิ่มว่า ถ้าสีเดียวกันผสม กัน 2 สี จะได้สีเดิม 
```
...
```text
ฉันได้เรียนรู้ว่าควรจะนึกถึงปัจจับหลายๆอย่าง ควรคิดให้รอบคอบ ควรนึกถึงสิ่งที่โจทย์สามารถเป็นไปได้
```
