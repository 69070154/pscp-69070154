...
| OJ submission ID, if submitted | 573951 |
| OJ status | Pass |
...
```text
ช่วยให้ Ai คิดว่าสูตรในการหาคนน้อยสุดหายังไงเพื่อเอามาเทียบกับคนมากสุด แล้ว ทำยังไง ถ้า คนน้อยสุดมีคะแนนติดลบ
```
...
```text
Ai ช่วยให้เห็นว่าใช้ max(0.0,คะแนนรวม - 2 * คนมากสุด) ทำให้ถ้าค่าคนน้อยสุดติดลบ ตัวmax ก็จะเอา 0.0 มาเพราะเป็นค่ามากสุด แล้วช่วยคิดสูตร หาคนคะแนน้อยสุดด้วย
```
...
```text
ฉันตรวจสอบว่า code ที่ฉันเขียนตอนแรก สามารถแก้ไขยังไงเพิ่มเติมจาก การแนะนำของAi
```
...
```text
ฉันได้เรียนรู้ วิธีหาจำนวนคะแนนของคนน้อยที่สุดว่าจะต้องทำยังไง แล้วทำยังไงถ้าคนคะแนนน้อยสุดมีค่าคะแนนติดลบ จะต้องใช้อะไรถึงจะทำให้ตัวแปร คะแนน ไม่ติดลบ
```
