...
```text
input:
1.จำนวนจริง คะแนนรวมทั้ง 3 คน
2.จำนวนจริง คะแนนคนที่มากที่สุด ใน 3 คนนี้
Output:
ถ้าคะแนนคนน้อยสุดกับคนมากสุดห่างเกิน 2 print"Surprising" แต่ถ้าน้อยกว่า print"Not Surprising"
Constraints:
input เป็นจำนวนจริง อาจจะทำให้มีเลขทศนิยมให้เยอะๅ
```
...
```text
step1: รับค่าจำนวนจริง ทั้ง 2  บรรทัด
step2:ใช้สูตร หา ว่าคนน้อย สุดกับ มากสุด ห่างกันเท่าไร
step3: ถ้าห่างเกิน  2 print"Surprising"
step4: ถ้าไม่ห่างเกิน 2 print"Not Surprising"
```
...
```text
วิธีสุดท้ายที่ใช้จริงไม่เหมือนแผนแรก เพราะ ถ้าสูตรที้ใช้คำนวณหาว่าคนน้อยสุดได้คะแนน น้อยกว่า 0 จะทำให้โค้ดขัดข้องได้ เลยต้องใช้ max(0.0,ตัวแปรคนน้อยสุด) เพื่อให้ตัวเลขติดลบ บังคับ เป็น 0.0
```
...
```text
เพราะค่า  ตัวเลขมากสุดไม่มีทางเป็น 1 เพราะคะแนนรวมคือ 20
```
...
```text
เพราะค่า มากสุด ลบกันในโค้ด ทำให้ ติดลบ แต่ มี max 0.00 ทำให้ ค่าน้อยสุดเป็น 0 เลยห่างกับมากสุด 10
```
...
```text
เพราะ คะแนนรวมติดลบ แต่เนื่องจากสูตร ทำให้ maxเป็น 0 แล้วเอาไปลบกับ 10 ถ้าให้มากกว่า 2
```
