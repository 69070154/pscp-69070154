...
```text
input:
รับค่าจำนวนจริงเต็มบวกหนึ่งค่าใน n
output:
print จำนวน n ถึง 0 ในบรรทัดเดียวที่หาร ด้วย 10 ลงตัว
constraints:
input เป็นจำนวนเต็มบวก แต่ใน code ไม่ได้บังคับให้เป็นจำนวนเต็มบวก ทำให้อาจจะใช้งานได้
```
...
```text
step1: รับค่า จำนวนเต็มบวก n
step2:ทำให้มันลูบใน i โดนการ start ที่ n แล้วstopที่ตัวสุดท้่าย แล้ว step -1 ไปเรื่อย
step3:แล้วก็กำหนดเงื่อนไขใน loop ว่า ถ้า i หารเอาเศษ == 0  ให้ print i
```
...
```text
วิธีสุดท้ายเหมือนแผนแรก เลย แต่เติม end = " " ไปใน print ด้วย เพื่อทำให้มัน เวลา print ออกมาจะอยู่บรรทัดเดียวกันแล้วทำให้ มันห่าง กันด้วย
```
...
```text
เพราะถ้าเราใส่ตัวเลขลบไป จะทำให้ ไม่ output อะไรออกมา
```
...
```text
เนื่องจาก ตัวรับค่าของเรามีแค่ int ที่เป็นจำนวนเต็ม ทำให้ไม่สามารถ ใส่ ทศนิยมได้
```
...
```text
อย่างให้เห็นตัวอย่าง ถ้าใส่ จำนวนเต็มบวกปกติ output จะออกมาเป็นยังไง
```
...
```text
ช่วยตั้งเงื่อนไข ในการ ให้ print ตัวเลข ที่หาร10 ลงตัว
```
